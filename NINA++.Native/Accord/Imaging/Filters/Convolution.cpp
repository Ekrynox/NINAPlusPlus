...
namespace LucasAlias::NINA::NinaPP::Accord::Imaging::Filters {
    ...
    void Process8bppImage(uint8_t* baseSrc, uint8_t* baseDst, int32_t srcStride, int32_t dstStride, int32_t srcOffset, int32_t dstOffset, int32_t startX, int32_t startY, int32_t stopX, int32_t stopY, int32_t* kernel, int32_t divisor, int32_t threshold, int32_t size, bool dynamicDivisorForEdges) {
        int i, j, t, k, ir, jr;
    ...
    void Process24bppImage(uint8_t* baseSrc, uint8_t* baseDst, int32_t srcStride, int32_t dstStride, int32_t srcOffset, int32_t dstOffset, int32_t startX, int32_t startY, int32_t stopX, int32_t stopY, int32_t pixelSize, int32_t* kernel, int32_t divisor, int32_t threshold, int32_t size, bool dynamicDivisorForEdges) {
    ...
    void Process32bppImage(uint8_t* baseSrc, uint8_t* baseDst, int32_t srcStride, int32_t dstStride, int32_t srcOffset, int32_t dstOffset, int32_t startX, int32_t startY, int32_t stopX, int32_t stopY, int32_t* kernel, int32_t divisor, int32_t threshold, int32_t size, bool dynamicDivisorForEdges) {
        int32_t i, j, t, k, ir, jr;
